...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/libssh2-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/libssh2-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add libssh2 libssh2-static
# for installing globally
pixi global install libssh2 libssh2-static
```
...
It is possible to list all of the versions of `libssh2` available on your platform:
...
```
pixi search libssh2 --channel conda-forge
```
