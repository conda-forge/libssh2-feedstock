...
mamba.exe install pip mamba conda-build conda-forge-ci-setup=4 "conda-build>=24.1" conda-libmamba-solver=24.1.0 -c conda-forge --strict-channel-priority --yes
if !errorlevel! neq 0 exit /b !errorlevel!
